...
1. It was built on Linux platform and will run better on it.(I say this because I have not tried running it on Windows or MacOS)
2. The script is written using python 3.x.
3. The script uses Selenium, so make sure its installed before running the script.
4. The webdriver for selenium here is Firefox(therefore there is a geckodriver driver file in the repository).
